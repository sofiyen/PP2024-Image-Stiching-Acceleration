...
int main(int argc, char *argv[])
{
    ...
    std::cout << "\nFinding keypoint time in main: " << compute_duration.count() << " ms" << std::endl;
    ...
    compute_duration = std::chrono::duration_cast<std::chrono::milliseconds>(end_compute - start_compute);
    std::cout << "Draw keypoints time: " << compute_duration.count() << " ms" << std::endl;


    result.save("result.jpg");

    compute_duration = std::chrono::duration_cast<std::chrono::milliseconds>(end_compute - start_compute);
    std::cout << "Save time: " << compute_duration.count() << " ms" << std::endl;
